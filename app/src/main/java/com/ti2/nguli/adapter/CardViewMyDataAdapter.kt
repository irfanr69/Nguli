...
import com.ti2.nguli.ScrollingActivity
...
class CardViewMyDataAdapter(private val listMyDatas: ArrayList<MyData>, val context: Context) :
    ...
    override fun onBindViewHolder(holder: CardViewViewHolder, position: Int) {
        ...
        holder.itemView.setOnClickListener {
            val moveWithObjectIntent = Intent(context, ScrollingActivity::class.java)
            moveWithObjectIntent.putExtra(ScrollingActivity.EXTRA_MYDATA, myData)
